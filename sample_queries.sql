-- QUERY 1
-- Tracks that have unusually high energy for their genre: >= 2 stdevs away
WITH genre_stats AS (
    SELECT
        genre_id,
...
-- QUERY 2
-- Underrepresented genres in your collections
-- Compared to the avg album count per genre in your personal collection 
...
-- QUERY 3
-- Most consistent popular artists, ranked by standard deviation of track popularity
SELECT
...
-- QUERY 5
-- "Hidden Gem" Albums: Albums you rated 4-5 stars but are significantly below global popularity average
SELECT 
